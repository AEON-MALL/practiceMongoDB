...
func handlePolls(w http.ResponseWriter, r *http.Request){
	...
	case "DELETE":
		...
		return
	case "OPTIONS":
		w.Header().Add("Accsess-Control-Allow-Methods", "DELETE")
...
func handlePollsPost(w http.ResponseWriter, r *http.Request){
	...
	if err := decodeBody(r, &p); err != nil{
		respondErr(w, r, http.StatusBadRequest, "リクエストからの調査項目を読み込めません", err)
		return
	}
